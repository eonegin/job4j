...
public class StartUITest {
    ...
    public void whenUserAddItemThenTrackerHasNewItemWithSameName() {
        ...
        Input input = new StubInput(new String[]{"0", "test name", "test desc", "12", "6"});   //создаём StubInput с последовательностью действий
    ...
    public void whenUpdateThenTrackerHasUpdatedValue() {
        ...
        Input input = new StubInput(new String[]{"2", item.getId(), "replace", "replace", "replace", "6"});
